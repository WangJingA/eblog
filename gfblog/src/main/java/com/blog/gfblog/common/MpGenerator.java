...
public class MpGenerator {
    ...
    private static String DATABASE = "jdbc:mysql://localhost:3306/assetment?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=Asia/Shanghai";       //数据库连接url
    ...
    private static String PARENT_PACKAGE = "com.blog.gfblog";            //基础包
